...
To deploy only IBM MQ, Kafka, Prometheus, and Grafana without the demo app:

```batch
deploy.bat deploy --infra-only
```

This automatically skips the build step and deploys only infrastructure components.
